...
public sealed class SocialMediaEventPhotoService : ISocialMediaEventPhotoService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var storedOriginalFileName = $"original{originalExtension}";
        var originalPath = Path.Combine(photoFolder, storedOriginalFileName);
        ...
        var photo = new SocialMediaEventPhoto
        {
            ...
            StoragePath = CombineStoragePath(storageKey, storedOriginalFileName),
