...
public class ProjectTotTrackerReadService
{
        ...
        bool includeRequestDetailColumns)
    {
        ...
        return query.Select(p => new ProjectSnapshot(
                ...
                p.Tot != null ? p.Tot.StartDatePrecision : PartialDatePrecision.None,
                p.Tot != null ? p.Tot.CompletedOn : null,
                p.Tot != null ? p.Tot.CompletionDatePrecision : PartialDatePrecision.None,
                ...
                p.TotRequest != null ? p.TotRequest.ProposedStartDatePrecision : PartialDatePrecision.None,
                p.TotRequest != null ? p.TotRequest.ProposedCompletedOn : null,
                p.TotRequest != null ? p.TotRequest.ProposedCompletionDatePrecision : PartialDatePrecision.None,
        ...
        CancellationToken cancellationToken)
    {
        ...
        foreach (var snapshot in snapshots)
        {
            ...
            rows.Add(new ProjectTotTrackerRow(
                ...
                snapshot.TotStartDatePrecision,
                snapshot.TotCompletedOn,
                snapshot.TotCompletionDatePrecision,
                totMetDetails,
                ...
                snapshot.RequestedStartDatePrecision,
                snapshot.RequestedCompletedOn,
                snapshot.RequestedCompletionDatePrecision,
                requestMetDetails,
    ...
    protected sealed record ProjectSnapshot(
        ...
        PartialDatePrecision TotStartDatePrecision,
        DateOnly? TotCompletedOn,
        PartialDatePrecision TotCompletionDatePrecision,
        ...
        PartialDatePrecision RequestedStartDatePrecision,
        DateOnly? RequestedCompletedOn,
        PartialDatePrecision RequestedCompletionDatePrecision,
