...
public class EditModel : PageModel
{
    ...
    public EditModel(VisitTypeService service, UserManager<ApplicationUser> userManager)
    {
        _service = service;
    ...
    public async Task<IActionResult> OnPostAsync(Guid id, CancellationToken cancellationToken)
    {
        ...
        {
            TempData["ToastMessage"] = "Visit type updated.";
        ...
        {
            ModelState.AddModelError(string.Empty, "Someone else updated this visit type. Please reload and try again.");
        }
        ...
        {
            ModelState.AddModelError(string.Empty, "Unable to update the visit type.");
        }
