...
public sealed class ConferenceTaskCommandServiceTests
{
    ...
    private sealed class CapturingTaskService : IActionTaskService
    {
        ...
        public Task AcceptSubmittedTaskAsync(int taskId, byte[] rowVersion, string closureRemarks, string closedByUserId, string role, CancellationToken cancellationToken = default) => throw new NotSupportedException();
