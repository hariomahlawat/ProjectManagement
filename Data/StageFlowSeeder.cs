...
public static class StageFlowSeeder
{
    ...
    private static StageTemplate[] BuildV2Stages()
    {
        ...
        return new[]
        {
            ...
            new StageTemplate { Version = version, Code = StageCodes.TEC, Name = "Technical Evaluation",   Sequence = 60, ParallelGroup = "PRE_COB" },
            new StageTemplate { Version = version, Code = StageCodes.BM,  Name = "Benchmarking",           Sequence = 70, ParallelGroup = "PRE_COB" },
