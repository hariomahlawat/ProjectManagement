...
builder.Services.AddScoped<IOpsSignalsService, OpsSignalsService>();
builder.Services.AddScoped<ISearchHealthService, SearchHealthService>();
...
builder.Services.AddScoped<OngoingProjectsReadService>();
builder.Services.AddScoped<IOngoingProjectsExcelBuilder, OngoingProjectsExcelBuilder>();
...
builder.Services.AddSingleton<IProliferationProjectExcelWorkbookBuilder, ProliferationProjectExcelWorkbookBuilder>();
...
builder.Services.AddScoped<IProliferationProjectExportService, ProliferationProjectExportService>();
