...
public sealed class AdminCapabilityCatalog : IAdminCapabilityCatalog
{
    ...
    private static IReadOnlyList<AdminCapabilityDescriptor> Build()
    {
        ...
        return new[]
        {
            ...
            ExternalCapability("erp-usage-view", "Review ERP Usage", "Review daily ERP adoption and meaningful interaction without relying on login counts.", Policies.Usage.View, Policies.Usage.ViewerRoles, AdminCapabilityRisk.High, "bi-person-check", Route(string.Empty, "/Usage/Index", "ERP usage")),
            ...
            Capability("holidays-manage", "Manage Holidays", "Maintain Gazetted Holidays, Restricted Holidays and office-observance decisions used by the shared calendar and scheduling calculations.", AdminPolicies.HolidaysManage, adminAndHod, AdminCapabilityRisk.Moderate, "bi-calendar-week", Route(string.Empty, "/Settings/Holidays/Index", "Holidays")),
