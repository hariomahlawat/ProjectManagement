...
public sealed partial class AuditActionPresentationCatalog : IAuditActionPresentationCatalog
{
    private static readonly IReadOnlyDictionary<string, AuditActionPresentation> KnownActions =
        new Dictionary<string, AuditActionPresentation>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["GazettedHolidayCreated"] = new("Gazetted Holiday created", "bi-calendar2-check", "success", "Master data", "Holiday"),
            ["RestrictedHolidayCreated"] = new("Restricted Holiday created", "bi-info-square", "success", "Master data", "Holiday"),
            ["RestrictedHolidayDeclaredOfficeHoliday"] = new("Restricted Holiday declared as office holiday", "bi-building-check", "warning", "Master data", "Holiday"),
            ["RestrictedHolidayOfficeObservanceWithdrawn"] = new("Restricted Holiday office observance withdrawn", "bi-building-dash", "warning", "Master data", "Holiday"),
