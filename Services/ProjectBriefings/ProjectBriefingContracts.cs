...
public sealed class ProjectBriefingDeckVm
{
    ...
    public FfcFootprintSummary FfcFootprintPreviewSummary { get; init; }
        = new(0, 0, 0, 0, 0, 0);
...
public sealed class ProjectBriefingSlideEstimateVm
{
    ...
    /// <summary>Total slides generated by the FFC block, including the main footprint slide and any country-wise breakdown pages.</summary>
    public int FfcGlobalFootprintSlides { get; init; }
    public int FfcCountryWiseBreakdownSlides { get; init; }
...
public sealed class ProjectBriefingDeckSettingsCommand
{
    ...
    public bool IncludeStageDistributionTable { get; init; }
    public ProjectBriefingPresentationTheme PresentationTheme { get; init; }
    public ProjectBriefingClosingSlideType ClosingSlideType { get; init; }
        = ProjectBriefingClosingSlideType.JaiHind;
    public ProjectBriefingInstitutionalProfileOptions InstitutionalProfileOptions { get; init; }
...
public sealed class ProjectBriefingFfcGlobalFootprintData
{
    ...
    public ProjectBriefingFfcGlobalFootprintLayout Layout { get; init; }
        = ProjectBriefingFfcGlobalFootprintLayout.MapWithCountryBreakdown;
    public bool IncludeCountryWiseBreakdown { get; init; }
