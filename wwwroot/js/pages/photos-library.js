...
(() => {
    ...
    const autoStart = library.dataset.selectionAutoStart === 'true';
    const cancelUrl = library.dataset.selectionCancelUrl || '';
    const targetedCuration = autoStart && cancelUrl.length > 0;
