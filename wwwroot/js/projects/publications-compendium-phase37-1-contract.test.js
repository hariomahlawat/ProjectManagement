...
test('phase 37.1 binds renderer change to a new review and PDF identity without a schema migration', () => {
  assert.match(fingerprint, /(?:compendium-review-v13-physical-measurement|compendium-review-v14-editorial-constraints)/);
  assert.match(readService, /CompendiumPdf_2026-08-16_(?:physical-composition-v20|editorial-constraints-v21)/);
});
