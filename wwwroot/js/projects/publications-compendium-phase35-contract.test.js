...
test('phase 35 evaluates readiness and review identity against the same authoritative fact', () => {
  ...
  assert.match(fingerprint, /compendium-review-v(?:10-sponsoring-line-directorate|11-balanced-text-flow|12-professional-typesetting|13-physical-measurement)/);
  assert.match(readService, /(?:CompendiumPdf_2026-08-15_(?:programme-particulars-v17|final-composition-v18|composition-hardening-v19)|CompendiumPdf_2026-08-16_physical-composition-v20)/);
});
