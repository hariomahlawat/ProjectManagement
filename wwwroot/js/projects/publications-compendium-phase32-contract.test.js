...
test('phase 32 ranks every valid one-page candidate instead of accepting first fit', () => {
  ...
  assert.match(pagination, /VisualHero => 315f/);
...
test('phase 32 advances review and PDF composition identities', () => {
  ...
  assert.match(readService, /CompendiumPdf_2026-08-15_(?:adaptive-composition-v12|production-hardening-v13|programme-iconography-v1[45]|programme-semantics-v16)/);
});
