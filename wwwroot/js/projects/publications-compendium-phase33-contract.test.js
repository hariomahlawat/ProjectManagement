...
test('phase 33 advances review and PDF identities so existing approvals do not mask changed presentation', () => {
  assert.match(fingerprint, /compendium-review-v(?:8-production-hardening|9-programme-iconography|10-sponsoring-line-directorate|11-balanced-text-flow|12-professional-typesetting|13-physical-measurement|14-editorial-constraints|15-additional-note-final-hardening|16-particulars-style|17-editorial-rules)/);
