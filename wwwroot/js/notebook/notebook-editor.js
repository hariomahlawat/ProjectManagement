...
export function initNotebookEditor(board, view, options = {}) {
  ...
  async function saveEditorPayload(data) { assertValidVersion(data.version); return NotebookApi.updateContent(item.id, data); }
