...
{
    public const string Phase = "46.2";
    public const string BuildStamp = "CompendiumPdf_2026-08-25_phase46.2-physical-layout-safety";
    ...
    public const string PdfContract = "physical-a4-v46.2";
    public const string HeaderName = "X-PRISM-Compendium-Build";
    public const string PdfProducer = "PRISM ERP / QuestPDF / Phase 46.2";
