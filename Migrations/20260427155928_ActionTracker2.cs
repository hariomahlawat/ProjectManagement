...
{
    /// <inheritdoc />
    public partial class ActionTracker2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultUserRoleId = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedLocation = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_StageChangeLogs_Action", "\"Action\" IN ('Requested','Approved','Rejected','DirectApply','Applied','Superseded','AutoBackfill','Backfill','ActualsUpdated')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    IndustryPartnerId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IndustryPartnerAttachments_IndustryPartners_IndustryPartner~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedByUserId = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    DeleteReason = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    IsAots = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    OcrStatus = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    OcrFailureReason = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
                    FirstViewedAtUtc = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "timezone('utc', now())"),
                    RowVersion = table.Column<byte[]>(type: "bytea", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveredOn = table.Column<DateOnly>(type: "date", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_FfcProjects_DeliveredOn_RequiresFlag", "\"DeliveredOn\" IS NULL OR \"IsDelivered\" = TRUE");
                    table.CheckConstraint("CK_FfcProjects_InstalledOn_RequiresFlag", "\"InstalledOn\" IS NULL OR \"IsInstalled\" = TRUE");
                    table.CheckConstraint("CK_FfcProjects_Quantity_Positive", "\"Quantity\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedByUserId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
                    RowVersion = table.Column<byte[]>(type: "bytea", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocRepoDocumentId = table.Column<Guid>(type: "uuid", nullable: true),
                    OcrStatus = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false, defaultValue: "None"),
                    OcrFailureReason = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
                    OcrLastTriedUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    TotId = table.Column<int>(type: "integer", nullable: true),
                    UploadedByUserId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalDescription = table.Column<string>(type: "character varying(5000)", maxLength: 5000, nullable: true),
                    ...
                    OriginalProjectTypeId = table.Column<int>(type: "integer", nullable: true),
                    OriginalIsBuild = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsLowResolution = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBuild = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    IsArchived = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "CreatedUtc", "DefaultUserRoleId", "DeletionRequestedByUserId", "DeletionRequestedUtc", "DisabledByUserId", "DisabledUtc", "Email", "EmailConfirmed", "FullName", "IsDisabled", "LastLoginUtc", "LockoutEnabled", "LockoutEnd", "LoginCount", "MustChangePassword", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PendingDeletion", "PhoneNumber", "PhoneNumberConfirmed", "Rank", "SecurityStamp", "ShowCelebrationsInCalendar", "TwoFactorEnabled", "UserName" },
                values: new object[] { "system", 0, "bb6d6cb5-52dd-432c-95d4-6b6a92d6a0d3", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, null, null, "system@example.local", true, "System Account", false, null, false, null, 0, false, "SYSTEM@EXAMPLE.LOCAL", "SYSTEM", null, false, null, false, "System", "c3f1e44d-21c7-4cd1-8d3a-2212333e2ef2", true, false, "system" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocRepoAudits_DocumentId_OccurredAtUtc",
                table: "DocRepoAudits",
            ...
            migrationBuilder.AddForeignKey(
                ...
                table: "ProjectProductionCostFacts",
                column: "ProjectId",
                principalTable: "Projects",
                principalColumn: "Id",
                onDelete: ReferentialAction.Cascade);
