            ...
            modelBuilder.Entity("ProjectManagement.Data.DocRepo.DocRepoAotsView", b =>
                {
                    ...
                    b.ToTable("DocRepoAotsViews", (string)null);
                });
            ...
            modelBuilder.Entity("ProjectManagement.Models.IndustryPartners.IndustryPartner", b =>
                {
                    ...
                    b.HasIndex("NormalizedName")
                        ...
                        .HasFilter("\"NormalizedLocation\" IS NULL");

                    b.HasIndex("NormalizedName", "NormalizedLocation")
                        .IsUnique()
                        .HasDatabaseName("UX_IndustryPartners_NormalizedName_NormalizedLocation")
                        .HasFilter("\"NormalizedLocation\" IS NOT NULL");

                    b.ToTable("IndustryPartners", (string)null);
                });

            modelBuilder.Entity("ProjectManagement.Models.IndustryPartners.IndustryPartnerAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("IndustryPartnerAttachments", (string)null);
                });

            modelBuilder.Entity("ProjectManagement.Models.IndustryPartners.IndustryPartnerContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("IndustryPartnerContacts", null, t =>
                        {
                            t.HasCheckConstraint("CK_IndustryPartnerContacts_PhoneOrEmail", "(nullif(trim(coalesce(\"Phone\", '')), '') is not null) OR (nullif(trim(coalesce(\"Email\", '')), '') is not null)");
                        });
                });

            modelBuilder.Entity("ProjectManagement.Models.IndustryPartners.IndustryPartnerProject", b =>
                {
                    b.Property<int>("IndustryPartnerId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("IndustryPartnerId", "ProjectId");

                    b.HasIndex("ProjectId");

                    b.ToTable("IndustryPartnerProjects", (string)null);
                });
            ...
            modelBuilder.Entity("ProjectManagement.Models.Arpp.ArppEntry", b =>
                {
                    ...
                    b.ToTable("ArppEntries", t =>
                        {
                            t.HasCheckConstraint("CK_ArppEntries_Category", "\"Category\" IN (1, 2, 3, 4)");
            ...
            modelBuilder.Entity("ProjectManagement.Models.Arpp.ArppIssue", b =>
                {
                    ...
                    b.HasIndex("FinancialYearStart", "IssueDate");
            ...
            modelBuilder.Entity("ProjectManagement.Models.Publications.BrochurePreset", b =>
                {
                    ...
                    b.Property<bool>("ShowBackCoverKicker")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<bool>("ShowBackCoverStrapline")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<bool>("ShowFrontCoverDescriptor")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
                    ...
                    b.Property<bool>("ShowFrontCoverKicker")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
